...
static const char *downvol[] = {"amixer", "set",    "Master",
                                "5%-",    "unmute", NULL};
...
static const Rule rules[] = {
    ...
    // { "Vivado",   NULL,       NULL,       0,            0,           1, -1 },
    {"ui-PlanAhead", NULL, NULL, 0, 0, 1, -1},
    {"kitty", NULL, NULL, 0, 0, 0, -1}, // Open on focused monitor
};
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_l, toggleworkspacelock, {0}},
    ...
    {MODKEY | ControlMask, XK_q, spawn,
     SHCMD("pkill -f [c]hadwm/scripts/bar.sh ; pkill -x chadwm")},
